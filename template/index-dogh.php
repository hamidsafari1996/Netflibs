...
<div class="container">
    <div class="">
        <div class="header-top-section text-right shadow-sm mb-3 mt-2" style="background: url('<?php echo  $pro_options[0]['img-3']; ?>');">
            <div class="title-top d-flex text-white">
                <i class="fas fa-compact-disc"></i>
                <h3><?php echo  $pro_options[0]['title-slug']; ?></h3>
            </div>
            ...
            <?php $coagex_filimo_option = woolearn_get_option('coagex_product_group');
                ...
                <?php
                $tax = $item['tax-film'];
                $posts = $item['test2_number'];
                $order = $item['order_id_3'];
                $filter = $item['orderby_id_3'];
                $target = $item['target_select_3'];
                $best_product = array(
