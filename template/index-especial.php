...
<div class="container-fluid">
   <div class="row section-style-one">
      <div class="col-6 text-right">
         <div class="espical-header mt-5">
            ...
            <?php echo  $header_options[0]['title']; ?>
            </h3>
      ...
      <div class="col-6 text-left">
         <div class="espical-header mt-5">
            <a href="<?php echo  $header_options[0]['link-button']; ?>" class="text-upper section-header-link mt-5"><span class="ml-3"><?php echo  $header_options[0]['title-button']; ?></span><i class="fas fa-arrow-left"></i></a>
         </div>
      </div> 
   </div>
   ...
   <?php $coagex_filimo_option = woolearn_get_option('coagex_product_group');
      ...
      $order = $item['order_id_1'];
      $filter = $item['orderby_id_1'];
      $target = $item['target_select_1'];
      $best_product = array(
