<?php
$worldsub_options=woolearn_get_option('coagex_product_group');
?>
<div class="container">
    <div class="">
        
        <div class="header-top-section text-right shadow-sm mb-3">
            <div class="title-top d-flex">
                <i class="fas fa-smoking"></i>
                <h3><?php echo  $worldsub_options[0]['title']; ?></h3>
            </div>
