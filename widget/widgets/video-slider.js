jQuery( window ).on( 'elementor/frontend/init', () => {
      elementorFrontend.hooks.addAction( 'frontend/element_ready/video-slider.default', function($scope, $){
        sinstances = plyr.setup('.front-js'); 
          $('.video-slider-netflibs').each(function () {
